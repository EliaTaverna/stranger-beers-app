"""Add form field columns to tally_submissions.
...
def upgrade() -> None:
    ...
    op.add_column("tally_submissions", sa.Column("phone", sa.String(50), nullable=True))
...
def downgrade() -> None:
    ...
    op.drop_column("tally_submissions", "phone")
